...
function IconExternal() {
  return (
    ...
    >
      <path
        d="M14 4h6v6M10 14 20 4M8 20H4v-4"
        strokeLinecap="round"
  ...
  return (
    <article className="user-panel" aria-labelledby="profile-heading">
      <div className="user-panel__hud">
        <span
          className="user-panel__corner user-panel__corner--tl"
          aria-hidden="true"
        />
        <span
          className="user-panel__corner user-panel__corner--tr"
          aria-hidden="true"
        />
        <span
          className="user-panel__corner user-panel__corner--bl"
          aria-hidden="true"
        />
        <span
          className="user-panel__corner user-panel__corner--br"
          aria-hidden="true"
        />
      </div>
    ...
    <div className="app">
      ...
      <header className="hero">
        ...
        <p className="hero__lede">
          Pull a profile through your stack. Cyberpunk chrome, Cursor-grade
          polish — one username away.
        </p>
      </header>
        ...
        <section className="command" aria-labelledby={`${formId}-legend`}>
          ...
          >
            ...
            <p id={`${formId}-legend`} className="command__hint">
              Hits <code className="command__code">/dev/:user</code> — served
              via an edge cache layer backed by a Node origin.
            </p>
          </form>
        </section>
          ...
          {status === "idle" && (
            <div className="placeholder">
              ...
              <p className="placeholder__text">
                Awaiting coordinates. Try a handle you love.
              </p>
            </div>
          )}
